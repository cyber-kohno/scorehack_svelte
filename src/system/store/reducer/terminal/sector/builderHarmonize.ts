...
const useBuilderHarmonize = (lastStore: StoreProps) => {
    ...
    const { changeHarmonizeTrack, getCurrHarmonizeTrack } = useReducerOutline(lastStore);
        ...
        return [
            {
                ...
                callback: () => {
                    ...
                    const tracks = lastStore.data.arrange.tracks.map((t, i) => ({ ...t, isActive: trackIndex === i }));
            ...
            },
            {
                ...
                args: [{
                    ...
                    getCandidate: () => lastStore.data.arrange.tracks.map(ht => ht.name)
                }],
                callback: (args) => {
