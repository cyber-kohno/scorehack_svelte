...
namespace PreviewUtil {
    ...
    export const startTest = (store: StoreProps, option: Option) => {
        ...
        const { getCurrScoreTrack } = useReducerMelody(store);
        const { adjustGridScrollXFromOutline, adjustOutlineScroll } = useReducerRef(store);
